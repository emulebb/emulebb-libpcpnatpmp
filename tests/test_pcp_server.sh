...
pcp-server -q >/dev/null 2>&1 && echo_exit "Unknown option test failed #1"
pcp-server --bad-argument >/dev/null 2>&1 && echo_exit "Unknown option test failed #2"


#Test timeout option because it is used latger on as part of other tests
killall pcp-server >/dev/null 2>&1
pcp-server --timeout 500 >/dev/null 2>&1 &
sleep 1
...
pcp-server -r 1 >/dev/null 2>&1 &
sleep 0.1
killall pcp-server || echo_exit "Failed setting default return code #1"
pcp-server -r 13 >/dev/null 2>&1 &
sleep 0.1
killall pcp-server || echo_exit "Failed setting default return code #2"
pcp-server -r 100 >/dev/null 2>&1 &
sleep 0.1
killall pcp-server >/dev/null 2>&1 && echo_exit "Failed setting default return code #3"
pcp-server -r 255 >/dev/null 2>&1 &
sleep 0.1
killall pcp-server >/dev/null 2>&1 || echo_exit "Failed setting default return code #4"

#PCP server version tests
pcp-server -v 1 >/dev/null 2>&1 &
sleep 0.1
killall pcp-server >/dev/null 2>&1 || echo_exit "Failed setting pcp-server version #1"
pcp-server -v 2 >/dev/null 2>&1 &
sleep 0.1
killall pcp-server >/dev/null 2>&1 || echo_exit "Failed setting pcp-server version #2"
pcp-server -v 3 > /dev/null &
sleep 0.1
killall pcp-server >/dev/null 2>&1 && echo_exit "Failed setting pcp-server version #3"
pcp-server -v 0 >/dev/null 2>&1 &
sleep 0.1
killall pcp-server >/dev/null 2>&1 && echo_exit "Failed setting pcp-server version #4"

# Log file tests
# Tests assumes the log file is being overwritten (current implementation)
pcp-server --log-file test.log --timeout 1000 >/dev/null 2>&1 &
sleep 0.1
pcpnatpmpc -v 1 -s 127.0.0.1 -i :1234 >/dev/null 2>&1 &
sleep 1.6
...
pcp-server --log-file test.log --timeout 1000 >/dev/null 2>&1 &
sleep 0.1
pcpnatpmpc -v 2 --server 127.0.0.1 --internal :1234 >/dev/null 2>&1 &
sleep 1.6
...
pcp-server --log-file test.log --timeout 1000 >/dev/null 2>&1 &
sleep 0.1
pcpnatpmpc -v 1 --server 127.0.0.1 -i :1234 -p 127.0.0.1:8888 >/dev/null 2>&1 &
sleep 1.6
...
pcp-server --log-file test.log --timeout 1000 >/dev/null 2>&1 &
sleep 0.1
pcpnatpmpc -s 127.0.0.1 -i :1234 -p 127.0.0.1:8888 >/dev/null 2>&1 &
sleep 1.6
...
pcp-server --log-file test.log --timeout 1000 >/dev/null 2>&1 &
sleep 0.1
pcpnatpmpc -s 127.0.0.1 -i :1234 -P >/dev/null 2>&1
sleep 1.6
...
sleep 0.1
printf '\000\000\000' | nc -w 1 -u 0.0.0.0 5351 >/dev/null 2>&1 &
sleep 1
killall pcp-server >/dev/null 2>&1
